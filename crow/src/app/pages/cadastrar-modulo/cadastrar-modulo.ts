...
@Component({
  ...
  templateUrl: './cadastrar-modulo.html',
  styleUrl: './cadastrar-modulo.css',
})
export class CadastrarModulo {
  
  etapaAtual = 1;

  // ETAPA 1: Dados do Módulo
  iconeModuloSelecionado: SafeHtml | null = null;
  nomeModulo = '';

  // ETAPA 2: Cadastrar Frase
  ...
  voltar(): void {
    // Navegar de volta para a página de visualizar idioma
    window.history.back();
    // Ou usar: this.router.navigate(['/visualizar-idioma']);
  }
